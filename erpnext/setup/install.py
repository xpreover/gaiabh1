...
default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://erpnext.org">ERPGG</a></div>"""
...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """ERPGG can only be installed on a fresh site where the setup wizard is not completed.
...
def check_frappe_version():
	...
	click.secho(
		f"You're attempting to install ERPGG version {erpnext_version} with Frappe version {frappe_version}. "
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "ERPGG")
